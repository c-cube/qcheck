...
(* OASIS_START *)
(* DO NOT EDIT (digest: b0e422ba6f973c629e7637c59901813c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "QCheck_runner_test.ml"
                   });
               Executable
                 ({
                     cs_name = "qcheck_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "QCheck_test.ml"});
               Doc
                 ({
                     cs_name = "qcheck";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest =
       Some "\140\234\167\185u\019\217\143\012\186\137\196\221\253\201\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
