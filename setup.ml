...
(* OASIS_START *)
(* DO NOT EDIT (digest: d1602992edb143cd16e0c46fba358d3a) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("qcheck", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("qcheck", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          description =
            Some
              "QuickCheck inspired property-based testing for OCaml. Also contains\nGabriel Scherer's random value generator library,\nhttps://github.com/gasche/random-generator";
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\177\186\205\150w\179\153\169\240\247\189\207\026\027\234I";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
