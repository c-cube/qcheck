...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00a16300de7de14085f0e254fdf8811d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some "QuickCheck inspired property-based testing for OCaml.";
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\242\162=\r\198\194q\201\169#\152uF\183\223\171";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
