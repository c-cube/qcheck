...
image::https://github.com/c-cube/qcheck/actions/workflows/main.yml/badge.svg[https://github.com/c-cube/qcheck/actions/workflows/main.yml[build]]
...
Jan Midtgaard has http://janmidtgaard.dk/quickcheck/index.html[a lecture] about
