  ...
  let test_float () =
    List.iter (alco_check (alcotest_float ) (trace_false Shrink.float) "on repeated failure")
      [ ("float max_float",    max_float,    [1.79769e+154; 1.79769e+231; 1.79769e+270; 1.79769e+289;
        ...
        ("float 9.00001",      9.00001,      [8.00001; 4.5; 6.8; 7.9; 8.5; 8.8; 8.9; 4.50001; 6.75001;
                                              7.87501; 8.43751; 8.71876; 8.85939; 8.9297; 8.96486; 8.98244;
                                              8.99123; 8.99562; 8.99782; 8.99892]);
    ...
    List.iter (alco_check alcotest_float (trace_true Shrink.float) "on repeated success")
      [ ("float max_float",    max_float,    [1.79769e+154; 1.79769e+77; 1.79769e+39; 1.79769e+20;
        ...
        ("float 100",          100.,         [10.; 1.]);
        ("float 10.00001",     10.00001,     [1.; 0.5; 5.; 4.; 3.; 2.; 1.]);
        ("float 9.00001",      9.00001,      [8.00001; 7.00001; 6.00001; 5.00001; 4.00001; 3.00001;
                                              2.00001; 1.00001; 0.5; 5.; 4.; 3.; 2.; 1.]);
