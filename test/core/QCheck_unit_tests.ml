  ...
  let test_float () =
    List.iter (alco_check (alcotest_float ) (trace_false Shrink.float) "on repeated failure")
      [ ("float max_float",    max_float,    [1.79769e+154; 1.79769e+231; 1.79769e+270; 1.79769e+289;
        ...
        ("float min_float",    min_float,    [2.22507e-154; 2.22507e-231; 2.22507e-270; 2.22507e-289;
                                              ...
                                              1.1e-308; 1.7e-308; 2e-308; 2.1e-308; 1.113e-308; 1.669e-308;
                                              1.947e-308; 2.086e-308; 2.156e-308; 2.191e-308; 2.208e-308;
                                              2.217e-308; 2.221e-308; 2.223e-308; 2.224e-308; 1.11254e-308;
                                              1.66881e-308; 1.94694e-308; 2.08601e-308; 2.15554e-308;
                                              2.19031e-308; 2.20769e-308; 2.21638e-308; 2.22073e-308;
                                              2.2229e-308; 2.22399e-308; 2.22453e-308; 2.2248e-308]);
        ...
        ("float 5e6",          5e6,          [5000.; 500000.; 3e+06; 2e+06; 2.5e+06; 3.8e+06; 4.4e+06;
                                              4.7e+06; 4.9e+06]);
        ...
        ("float 9.00001",      9.00001,      [5.00001; 3.00001; 2.00001; 4.5; 6.8; 7.9; 8.5; 8.8; 8.9;
                                              4.50001; 6.75001; 7.87501; 8.43751; 8.71876; 8.85939;
                                              8.9297; 8.96486; 8.98244; 8.99123; 8.99562; 8.99782; 8.99892]);
    ...
    List.iter (alco_check alcotest_float (trace_true Shrink.float) "on repeated success")
      [ ("float max_float",    max_float,    [1.79769e+154; 1.79769e+77; 1.79769e+39; 1.79769e+20;
        ...
        ("float 9.00001",      9.00001,      [5.00001; 3.00001; 2.00001; 1.]);
  ...
  let test_float_bound () =
    List.iter (fun (name,bound,arg,res) -> alco_check alcotest_float (trace_false (Shrink.float_bound bound)) "on repeated failure" (name,arg,res))
      [ ("float_bound max_float max_float",     max_float,   max_float,   [1.79769e+154; 1.79769e+231; 1.79769e+270; 1.79769e+289;
                                                                           ...
                                                                           1.78365e+308; 1.79067e+308; 1.79418e+308; 1.79594e+308;
                                                                           1.79682e+308; 1.79726e+308; 1.79748e+308]);
        ("float_bound max_float pi",            max_float,   Float.pi,    [3.; 1.14159; 1.1; 2.1; 2.6; 2.9; 3.; 1.071; 2.106; 2.624;
        ...
        ("float_bound 1e6 3.00003",             1e6,         3.00003,     [1.00003; 1.; 2.; 2.5; 2.8; 2.9; 1.00002; 2.00003; 2.50003;
        ...
        ("float_bound -1. -1.",                 -1.,         -1.,         [0.]);
        ("float_bound -10. -10.",               -10.,        -10.,        [-0.1; -5.; -8.; -9.]);
        ("float_bound -1e6 -1.00001",           -1e6,        -1.00001,    [0.; -0.5; -0.8; -0.9; -1e-05; -0.50001; -0.75001;
                                                                           -0.87501; -0.93751; -0.96876; -0.98439; -0.9922; -0.99611;
                                                                           -0.99806; -0.99904; -0.99953; -0.99977]);
        ("float_bound -1e6 -3.00003",           -1e6,        -3.00003,    [-1.00003; -1.; -2.; -2.5; -2.8; -2.9; -1.00002; -2.00003;
        ...
        ("float_bound -1e6 -1e6",               -1e6,        -1e6,        [-999.001; -99999.1; -499999.; -799999.; -899999.]);
        ("float_bound -.max_float -1.",         -.max_float, -1.,         [0.]);
        ("float_bound -.max_float -.pi",        -.max_float, -.Float.pi,  [-3.; -1.14159; -1.1; -2.1; -2.6; -2.9; -3.; -1.071; -2.106;
    ...
    List.iter (fun (name,bound,arg,res) -> alco_check alcotest_float (trace_true (Shrink.float_bound bound)) "on repeated success" (name,arg,res))
      [ ("float_bound max_float max_float",     max_float,   max_float,   [1.79769e+154; 1.79769e+77; 1.79769e+39; 1.79769e+20;
        ...
        ("float_bound 1e6 3.00003",             1e6,         3.00003,     [1.00003; 0.]);
  ...
  let test_float_range () =
    List.iter
      ...
      [ (* positive ranges *)
        ...
        ("float_range 10. 100. 100.",              10.,         100.,        100.,        [18.1; 60.; 40.; 30.; 55.; 78.; 89.; 95.; 98.; 99.]);
        ("float_range 10. 100. 50.",               10.,         100.,        50.,         [13.1; 30.; 30.; 40.; 45.; 48.; 49.]);
        ("float_range 10. 100. 11.000001",         10.,         100.,        11.000001,   [10.; 10.5; 10.8; 10.9]);
        ...
        ("float_range -10. 10. -10.",              -10.,        10.,         -10.,        [8.; -6.; -4.; -3.]);
        ("float_range -10. 10. -1.",               -10.,        10.,         -1.,         []); (*triggers [float 0.] above*)
        (* negative ranges *)
        ("float_range -100. -10. -10.",            -100.,       -10.,        -10.,        []);
        ("float_range -100. -10. -50.",            -100.,       -10.,        -50.,        [-13.1; -30.; -30.; -40.; -45.; -48.; -49.]);
        ("float_range -100. -10. -100.",           -100.,       -10.,        -100.,       [-18.1; -60.; -40.; -30.; -55.; -78.; -89.; -95.; -98.; -99.]);
