...
module type QCHECK_BASE_RUNNER = sig
  ...
  *)
  ...
  val run_tests_main : ?argv:string array -> QCheck_common.Test.t list -> 'a
  ...
  *)
  ...
  module Raw : sig
    ...
    val callback :
      ...
      print_res:bool ->
      print:('a, 'b) printer ->
      string -> 'c QCheck_common.Test.cell -> 'c QCheck_common.TestResult.t -> unit
